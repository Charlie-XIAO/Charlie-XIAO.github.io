...
const SKLEARN_MERGED_PRS = 32;
const SKLEARN_LINES_ADDITION = 988;
const SKLEARN_LINES_DELETION = 257;
const SKLEARN_RANK_CONTRIBUTOR = 79;

/* Statistics for pandas */

const PANDAS_MERGED_PRS = 17;
const PANDAS_LINES_ADDITION = 603;
const PANDAS_LINES_DELETION = 155;
const PANDAS_RANK_CONTRIBUTOR = 96;
