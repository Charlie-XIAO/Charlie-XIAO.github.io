...
const SKLEARN_MERGED_PRS = 33;
const SKLEARN_LINES_ADDITION = 999;
const SKLEARN_LINES_DELETION = 265;
const SKLEARN_RANK_CONTRIBUTOR = 75;

/* Statistics for pandas */

const PANDAS_MERGED_PRS = 19;
const PANDAS_LINES_ADDITION = 840;
const PANDAS_LINES_DELETION = 172;
const PANDAS_RANK_CONTRIBUTOR = 88;
